...
use libkernel::fs::{
    ...
    inode::{
        DirInodeBackend, DynBytesInode, DynBytesInodeCoercion, DynDirInode, DynDirInodeCoercion, DynInode, InodeMeta,
        InodeMode,
    },
};
...
impl FatDir {
    ...
    fn create(fat: Arc<FileAllocTable>, _name: &str) -> KResult<Self> {
